...
def run_test(test_size, i):
	...
	if i == 1:
		...
		plot_colours(test_colours, greedyPerm, "Constructive Greedy Heuristic ({} Colors)".format(test_size))
		...
		plot_colours(test_colours, multi_sa_perm, "Multi-Start Hill Climbing ({} Colors)".format(test_size))
		plt.figure()
